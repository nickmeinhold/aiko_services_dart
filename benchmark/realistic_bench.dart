...
List<String> buildCorpus(int n) {
  ...
  return [
    for (var i = 0; i < n; i++)
      switch (rnd(4)) {
        0 =>
          '(process_frame (stream_id: ${rnd(99999)} frame_id: ${rnd(99999)}) '
        ...
        2 =>
          '(state_update (topic: aiko/host/${rnd(99)}/${rnd(99)}/state '
...
void main(List<String> args) {
  ...
  print(
    'realistic parse ${(sw.elapsedMicroseconds / n).toStringAsFixed(3)} us/msg '
